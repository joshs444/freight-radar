...
import type { TimeseriesSeries } from '../types.ts';
...
export function SparkHistory({ s, dates, asOf, baseline, color = '#e07b12' }: SparkHistoryProps) {
