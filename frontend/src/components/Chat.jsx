...
import { ask, buildIndex, SUGGESTED } from '../lib/ask.js';
...
export default function Chat({ data, onPickEntity }) {
              ...
              m.role === 'user' ? (
                ...
                <div key={i} className="fr-chat-msg bot">
                  ...
                  {m.entity && onPickEntity && (
                    <button className="fr-chat-jump" onClick={() => onPickEntity(m.entity.portid)}>
