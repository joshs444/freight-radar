  ...
  return (
    <div className="fr-onb">
      ...
      <ul className="fr-onb-list">
        <li>
          <b>Stress index + brief</b> up top — the at-a-glance state of global freight.
        </li>
        <li>
          <b>Globe + feed</b> — click any flagged chokepoint for the real numbers behind it.
        </li>
        <li>
          <b>Ask Freight Radar</b> (bottom-right) — a chat that only says what it can cite.
        </li>
        <li>
          <b>Your data</b> — drop a trade CSV; exposure recomputes in your browser, privately.
        </li>
      </ul>
