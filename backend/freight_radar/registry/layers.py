...
REGISTRY: tuple[LayerDescriptor, ...] = (
    ...
    LayerDescriptor(
        ...
        output="streamflow",
        manifest_sidecar=True,
        fetch_file="data/streamflow.json",
        appdata_key="streamflow",
        globe=Globe("streamflow", "Context", "rivers", "river", False, 8),
    ...
    LayerDescriptor(
        ...
        output="eonet",
        manifest_sidecar=True,
        fetch_file="data/eonet.json",
        appdata_key="eonet",
        globe=Globe("eonet", "Context", "events", "event", False, 5),
    ...
    LayerDescriptor(
        ...
        output="marine",
        manifest_sidecar=True,
        fetch_file="data/marine.json",
        appdata_key="marine",
        globe=Globe("marine", "Context", "seas", "wave", False, 6),
    ...
    LayerDescriptor(
        ...
        output="tides",
        manifest_sidecar=True,
        fetch_file="data/tides.json",
        appdata_key="tides",
        globe=Globe("tides", "Context", "tides", "tide", False, 7),
